        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Messages sent to other nodes</p>
                </div>
            ...
            <Card>
                <CardContent className="pt-6">
                    <div className="flex items-center gap-2 mb-6 text-muted-foreground">
                        ...
                        <span className="text-sm font-medium uppercase tracking-wider">Sent Messages ({sentLetters.length})</span>
                    </div>
